...
class EnablePassword:
    def __init__(self, hostAddress, username, password, enablePassword):
...
enable = EnablePassword('10.10.20.48','developer','C1sco12345','Cisco1234')
returnedEnable = enable.getEnablePassword()
enable = enable.setEnablePassworde()
print(returnedEnable)