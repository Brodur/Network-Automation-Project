...
def main():
    """Main method that retrieves the OSPF details from the router via RESTCONF."""

    # url string to issue GET request
    url = "https://{h}/restconf/data/Cisco-IOS-XE-native:native/router/ospf".format(h=ipAddress)
